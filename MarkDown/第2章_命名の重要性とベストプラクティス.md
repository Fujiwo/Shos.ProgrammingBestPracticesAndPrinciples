...
プログラミングとは:
![暗黙知の形式知化](Images/2.1.accountability.1.svg)
...
<!-- 図2.3: Name and Conquer フローチャート -->
![図2.3 Name and Conquer フローチャート](Images/02-name-and-conquer-flow.svg)
...
<!-- 図2.4: 語彙マップ -->
![図2.4 語彙マップ](Images/02-vocabulary-map.svg)
...
ユーザーにとっては、ユーザー インターフェイスの名前がそのものの名前となる。

システムを開発する目的は、顧客の問題をITで解決することである。
...
クライアント視点でみると: プログラムで使われている名前は、プログラムがクライアントに提供するインタフェイス。

名前＝インタフェイス

クライアント視点でみると:プログラムで使われている名前は、プログラムがクライアントに提供するサービスの名称。
...
![Service Oriented Naming 概念図](Images/service-oriented-naming-concept.md)

### 2.5.2 ユーザーインターフェースとしての名前
