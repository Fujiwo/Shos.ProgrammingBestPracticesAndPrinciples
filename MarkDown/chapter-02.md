...
![第2章バナー](../website/Images/chapter-02-banner.svg)
...
![HowからWhatへのパラダイムシフト](../website/Images/2.1.accountability.1.svg)
...
![時間とともにソフトウェアのエントロピーは増大](../website/Images/2.3.nameandconquer.1.svg)
...
![“Employee" という名前付けで概念の範囲を指定](../website/Images/2.3.nameandconquer.2.svg)

そうして “Employee" という名前付けによって、概念が認識できるようになる。これは、暗黙知の形式知化であるとも言えるであろう。
![暗黙知の形式知化](../website/Images/2.2.modeling.1.svg)
...
``` -->
![二次元ベクトルの絶対値](../website/Images/2.4.vector2d.png)

**2点 a とb の距離 d**
<!-- ```math
d = \lvert \vec{a} - \vec{b} \rvert
``` -->
![2点 a とb の距離 d](../website/Images/2.4.vector.png)
...
これがテレビ? これが電話?
![テレビと電話](../website/Images/2.5.tvandphone.1.png)
...
![テレビ=インターフェイス](../website/Images/2.5.tvandphone.2.png)
...
![SON](../website/Images/2.5.son.0.svg)
...
**クライアントにサービスを提供**
![SON](../website/Images/2.5.son.1.svg)
...
**名前は顧客側の視点で決定**
![SON](../website/Images/2.5.son.2.svg)

**サービス指向の名前付け**
![SON](../website/Images/2.5.son.3.svg)

**Service Oriented Naming**
![SON](../website/Images/2.5.son.4.svg)
...
ニュアンスまで考えて意味が近いものを適切に選ぶ、のが良い。そのためには、英語を勉強することも必要になると思う。

プログラミングを始めてから英語を復習するのはまだ楽だが、国語力がない人がプログラミングをマスターするのは結構大変である。プログラミングは、厳密に自分の語彙を作り、それで何をやるかを記述する、という作業だからである。
