...
良い開発ツールを使うのは大切なことである。 効率的に楽しくプログラミングできるからだ。使っていてイライラするツールでは、せっかくのプログラミングが楽しくならない。

「弘法筆を選ばず」という言葉がある。書の名人である弘法大師(空海)はどんな筆であっても良い字が書けるという意味である。「本当に技量が優れていれば、どんな道具を使っても立派な仕事ができる」というときに使われる。しかし本当にそうだろうか。

実際には、空海は書きたい字によって筆を使い分けたといわれている。また、空海と同時代では嵯峨天皇と橘逸勢も優れた書家とされており、この三人を「三筆」と呼ぶが、空海は同じ三筆の嵯峨天皇にも筆を選ぶようにアドバイスしていたそうである。空海自身は、名人であっても道具は重要と考えていたようだ。

ソフトウエア開発においても道具は重要である。良い開発ツールは、プログラミングに集中できる環境を提供する。悪い開発ツールは、それを使うことに振り回され、プログラマの思考を妨げる。

本来やるべきプログラミング以外の雑務を肩代わりしてくれる、プログラマの考えを邪魔しないツール。プログラマたるもの、そのようなツールを選び使いたいものである。
